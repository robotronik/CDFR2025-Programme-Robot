...
#define HIGHWAY_POINTS_COUNT 8
#define HIGHWAY_LINES_COUNT 14
static highway_point points[] = {{320, 0},{-200, 920},{300, 920},{-190, 0},{-200, -920},{300, -920},{310, 300},{310, -300},};
static highway_line lines[] = {{3, 1},{6, 2},{3, 4},{7, 5},{0, 6},{0, 7},{1, 4},{0, 5},{0, 2},{2, 5},{5, 6},{2, 7},{1, 2},{4, 5},};
