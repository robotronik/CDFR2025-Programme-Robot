...
// ACTION 1 : CHERCHER DU STOCK
    takeStock0->setStartPoint(0,0,CmdAsserv::FORWARD,CmdAsserv::SHORTEST); //replace 0,0 by coords of Stock[0]
...
// ACTION 2 PUT IN CONSTRUCTION ZONE 
    putInConstruction0->setStartPoint(0, 0, 90, CmdAsserv::FORWARD, CmdAsserv::SHORTEST);
    putInConstruction0->setEndPoint(0, 0, 90, CmdAsserv::MOVE_BACKWARD, CmdAsserv::SHORTEST);
...
//    turnSolarPanelAction->setStartPoint(810,(itable->robot.colorTeam == YELLOW ? 1100 : -1100),(itable->robot.colorTeam == YELLOW ? -90 : 90), CmdAsserv::FORWARD, CmdAsserv::SHORTEST);
...
//    listeAction.push_back(turnSolarPanelAction);
        ...
        // ACTION 4
    returnToHomeAction->setStartPoint(700,(itable->robot.colorTeam == YELLOW ? 1200 : -1200), CmdAsserv::FORWARD, CmdAsserv::SHORTEST);
    ...
    //ACTION 5
    waitFin->setStartPoint(700,0,(itable->robot.colorTeam == YELLOW ? -90 : 90),CmdAsserv::FORWARD,CmdAsserv::SHORTEST);
