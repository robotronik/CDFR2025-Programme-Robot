...
actionContainer::actionContainer(robotCDFR* imainRobot, Asser* irobot, Arduino* iarduino, tableState* itable){
    ...
    action* JardiniereTab[6]{ putInJardiniere0 = new action("putInJardiniere0",imainRobot,irobot,iarduino,itable),
    ...
    action* PotAction[4]{ pushPotAction0 = new action("putInJardiniere0",imainRobot,irobot,iarduino,itable),
