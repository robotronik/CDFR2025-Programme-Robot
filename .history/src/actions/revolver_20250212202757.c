...
void DisplayRobot(){
    ...
    printf("%d        %d             %d        %d\n", lowBarrelTab[0], lowBarrelTab[5],highBarrel[0], highBarrel[5]);
    printf("%d        %d             %d        %d\n", lowBarrelTab[13], lowBarrelTab[6],highBarrel[13], highBarrel[6]);
    printf("%d        %d             %d        %d\n", lowBarrelTab[12], lowBarrelTab[7],highBarrel[12], highBarrel[7]);
    printf(" %d %d %d %d                %d %d %d %d\n", lowBarrelTab[11], lowBarrelTab[10], lowBarrelTab[9], lowBarrelTab[8],highBarrel[11], highBarrel[10], highBarrel[9], highBarrel[8]);
...
void SpinBarrel(int n, int num_tab) {//lowBarrel 1er = 1: highBarrel 2ème = 2
    int *lowBarrel_actuel = (num_tab == 1) ? lowBarrelTab : highBarrel;
    int temp[SIZE];
...
void LoadStock(int direction){// Ajoute une boîte en fonction de la direction (droite = 1, gauche = 0)
