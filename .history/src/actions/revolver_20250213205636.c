...
bool MoveColumns(int direction, int sens) { 
    ...
    if (sens == 1 && highBarrelTab[start] == 1) {printf("T'essais de monter des boîtes de conserve où il y en a déjà\n");}
    ...
    return true; // TODO: Remplacer par ArduinoMoveColumns() si nécessaire
}
